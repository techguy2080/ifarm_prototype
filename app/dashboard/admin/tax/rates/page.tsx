...
import { Percent, Plus, Edit, Calendar, CheckCircle, XCircle, Info } from 'lucide-react';
...
export default function SuperAdminTaxRatesPage() {
  ...
  const handleEdit = (rate: TaxRate) => {
    ...
    setFormData({
      ...
      is_system_default: rate.is_system_default,
  ...
  const handleSubmit = () => {
    ...
    console.log('Submitting system tax rate:', formData);
    setCreateDialogOpen(false);
    setEditDialogOpen(false);
  };

  // Show only system-wide tax rates (tenant_id is null)
  const systemRates = mockTaxRates.filter(r => r.tenant_id === null || r.is_system_default);
      ...
      <Box sx={{ width: '100%', maxWidth: '1400px' }}>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, flex: 1 }}>
                ...
                <Box>
                  ...
                  <Typography variant="body2" sx={{ color: 'rgba(255, 255, 255, 0.9)' }}>
                    Manage system-wide tax rates for all tenants (Uganda - URA Compliant)
                  </Typography>
                </Box>
              </Box>
              <Button
        ...
        >
          <Typography variant="body2" sx={{ fontWeight: 600, mb: 0.5 }}>
            System-Wide Tax Rates
          </Typography>
          <Typography variant="body2">
            System tax rates are available to all tenants as defaults. Tenants can create their own custom rates,
            but system rates serve as the baseline for Uganda Revenue Authority (URA) compliance.
          </Typography>
        </Alert>
                    ...
                    <TableRow>
                      <TableCell colSpan={9} align="center" sx={{ py: 4 }}>
                        <Typography variant="body2" color="text.secondary">
                          No system tax rates found. Create your first system-wide tax rate.
                        </Typography>
                      </TableCell>
                    </TableRow>
                  ) : (
        ...
        >
          <DialogTitle>
            {editDialogOpen ? 'Edit System Tax Rate' : 'Create System Tax Rate'}
          </DialogTitle>
          <DialogContent>
            <Stack spacing={3} sx={{ mt: 2 }}>
              <Alert severity="info">
                System tax rates are available to all tenants as defaults. This will be used across the entire platform.
              </Alert>
              <TextField
                label="Tax Name"
              ...
              <FormControlLabel
                ...
                label="System Default (Always enabled for system rates)"
              />
            </Stack>
          </DialogContent>
          <DialogActions>
